...
Digital Clock:
    ...
    * [Optional: Add any other features, like "Displays the current date."]

Stopwatch:
    * **Start / Stop:** Toggle functionality to run and pause the timer.
    * **Lap:** (If you added this feature) Record and display lap times without stopping the main count.
    * **Reset:** Clears the stopwatch time back to zero.
